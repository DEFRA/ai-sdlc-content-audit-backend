...
```bash
cd ai-sdlc-content-audit-backend
nvm use
```
...
```bash
docker build --no-cache --tag ai-sdlc-content-audit-backend .
```

Run:

```bash
docker run -e PORT=3001 -p 3001:3001 ai-sdlc-content-audit-backend
```
